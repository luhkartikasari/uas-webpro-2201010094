                        ...
                        <div class="card mb-4">
                            ...
                            <form  method="post" action="post.php" enctype="multipart/form-data">
                              <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="posisi" placeholder="Nama Jabatan / Posisi" required>
                                
                              </div>
                              <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Perusahaan</label>
