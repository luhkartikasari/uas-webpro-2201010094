            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Setting Halaman About</h1>
                   ...
                   ?>
                            <form  method="post" action="update.php" enctype="multipart/form-data">
                              <div class="mb-3">
                                ...
                                <input type="email" class="form-control" name="email" value="<?php echo $d['email']; ?>" required>
                                
                              </div>
                              <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Kontak</label>
                                <input type="text" class="form-control" name="kontak" value="<?php echo $d['kontak']; ?>"  required>
                              </div>
                              <div class="mb-3">
                              ...
                              <div class="mb-3">
                                ...
                                <textarea class="form-control" name="deskripsi"><?php echo $d['deskripsi']; ?></textarea>
                              </div>
