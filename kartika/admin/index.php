                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Data Pendidikan
                                <a href="create.php" class="btn btn-success float-end">Tambah</a>
                            </div>
                            <div class="card-body">
                    ...
                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="ubah.php?id=<?php echo $d['id']; ?>" class="btn btn-primary"><i class="fas fa-pencil"></i></a>
                                                <a href="delete.php?id=<?php echo $d['id']; ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                         <?php 
                        }
